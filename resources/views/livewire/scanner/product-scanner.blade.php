...
>
    ...
    <div class="py-6 pt-0 space-y-6">
            ...
            <div class="relative bg-black rounded-lg overflow-hidden aspect-video">
                ...
                @if ($cameraError)
                    <div class="absolute inset-0 bg-red-900/90 flex flex-col items-center justify-center p-4">
                        ...
                        <flux:button size="sm" variant="danger" wire:click="$dispatch('error-cleared')" class="mt-4">
                            Try Again
                        </flux:button>
                    </div>
                @endif
        ...
        @if ($autoSubmitInProgress && $product)
            <flux:callout icon="arrow-path" color="green">
                <flux:callout.heading>Auto-submitting scan...</flux:callout.heading>
                <flux:callout.text>{{ $product->name }} (Qty: 1)</flux:callout.text>
            </flux:callout>
        @endif
