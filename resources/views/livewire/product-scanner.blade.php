    ...
    <div class="px-4 py-4 sm:px-6">
        ...
        @if(!$barcodeScanned && !$showRefillForm)
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 overflow-hidden mb-4">
                <div class="relative">
                        <!-- Camera View (always present for JS to find) -->
                        <div class="relative">
                            <video
                                id="video"
                            ...
                            <!-- Loading Overlay (when camera is waking up) -->
                            @if($loadingCamera)
                                <div class="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-green-50 dark:from-zinc-800 dark:to-zinc-700">
                                    <!-- Pulsing Camera Icon -->
                                    <div class="relative mb-4">
                                        <div class="absolute inset-0 rounded-full bg-blue-400 opacity-25 animate-ping"></div>
                                        <div class="relative bg-blue-600 p-4 rounded-full">
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-300 text-center max-w-xs">
                                        Initializing camera hardware and preparing to scan
                                    </p>
                            ...
                            <!-- Camera Overlay -->
                            @if(!$isScanning && !$loadingCamera)
                                <div class="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-sm">
                                    <div class="text-center text-white px-6 py-4">
                                        <!-- Animated camera icon -->
                                        <div class="mb-3">
                                            <svg class="w-16 h-16 mx-auto opacity-90 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                            </svg>
                                        </div>
                                        
                                        <p class="text-xl font-semibold mb-2">📱 Ready to Scan</p>
                                        <p class="text-sm opacity-90">Tap the green button to start scanning</p>
