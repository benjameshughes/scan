...
<nav x-data="{ open: false }" class="bg-white dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700 shadow-sm">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('scan.scan')" :active="request()->routeIs('scan.scan')" wire:navigate>
                        {{ __('Scan') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('scan.scan')" :active="request()->routeIs('scan.scan')"
                                   wire:navigate>
                {{ __('Scanner') }}
            </x-responsive-nav-link>
