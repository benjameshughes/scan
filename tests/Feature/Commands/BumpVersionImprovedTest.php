...
use App\Console\Commands\BumpVersionImproved;
...
beforeEach(function () {
    ...
    $this->readmePath = base_path('README.md');
    ...
    if (File::exists($this->readmePath)) {
        $this->originalReadme = File::get($this->readmePath);
    }
...
afterEach(function () {
    ...
    if (isset($this->originalReadme)) {
        File::put($this->readmePath, $this->originalReadme);
    } else {
